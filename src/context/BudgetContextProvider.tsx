...
export const BudgetContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    const [budgetItems, setBudgetItems] = useState<BudgetItem[]>(() => {
      console.log("Initializing budget items from localStorage...");
        ...
        // Load from localStorage if available (runs only on first render)
  ...
  // Add a new budget item (available to all components via context)
  ...
  return (
  <BudgetContext.Provider value={{ budgetItems, addBudgetItem, deleteBudgetItem, setBudgetItems }}>
    {children}
